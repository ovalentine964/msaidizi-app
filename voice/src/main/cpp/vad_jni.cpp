...
Java_com_msaidizi_voice_VadEngine_nativeCreateVad(
...
Java_com_msaidizi_voice_VadEngine_nativeProcessAudio(
        JNIEnv* env, jobject /* thiz */,
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_msaidizi_voice_VadEngine_nativeIsSpeech(
        JNIEnv* /* env */, jobject /* thiz */,
        jlong handle) {
...
Java_com_msaidizi_voice_VadEngine_nativeReset(
        JNIEnv* /* env */, jobject /* thiz */,
        jlong handle) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_msaidizi_voice_VadEngine_nativeDestroyVad(
        JNIEnv* /* env */, jobject /* thiz */,
        jlong handle) {
