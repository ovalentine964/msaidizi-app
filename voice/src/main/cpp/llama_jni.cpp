...
Java_com_msaidizi_voice_LlamaCppEngine_nativeLoadModel(
...
Java_com_msaidizi_voice_LlamaCppEngine_nativeGenerate(
        JNIEnv* env, jobject /* thiz */,
...
Java_com_msaidizi_voice_LlamaCppEngine_nativeUnloadModel(
        JNIEnv* env, jobject /* thiz */,
        jlong handle) {
