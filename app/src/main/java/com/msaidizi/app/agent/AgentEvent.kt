...
sealed class AgentEvent {
    ...
    /**
     * Agent-to-Agent message event.
     * Dispatched by A2AProtocol for inter-agent communication.
     */
    data class A2AMessageEvent(
        override val eventId: String,
        override val timestamp: Long,
        override val source: String,
        val message: com.msaidizi.app.agent.a2a.A2AMessage
    ) : AgentEvent()
    ...
    /**
     * Proactive alert fired by the alert engine.
     */
    ...
    /**
     * Cross-domain insight generated by the knowledge graph.
     */
