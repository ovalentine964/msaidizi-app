...
dependencies {
    ...
    // Sherpa-ONNX — Offline STT (Whisper) and TTS (Piper/Kokoro)
    // Includes pre-built JNI libs for arm64-v8a, armeabi-v7a, x86_64
    implementation("com.k2fsa.sherpa:onnx:1.10.40")
